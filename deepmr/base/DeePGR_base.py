...
class DeePGR_base_class():
    ...
    def generate_dir(self):
        ...
        os.makedirs(f'{self.working_dir}/data/weight_data', exist_ok=True)
        os.makedirs(f'{self.working_dir}/log/gendata', exist_ok=True)
        os.makedirs(f'{self.working_dir}/log/evaluate', exist_ok=True)
    ...
    def load_path(self):
        ...
        self.weight_data_path = f'{self.working_dir}/data/weight_data'
        self.log_path = f'{self.working_dir}/log'
        self.log_gen_data_path = f'{self.working_dir}/log/gendata'
        self.log_evaluate_path = f'{self.working_dir}/log/evaluate'
